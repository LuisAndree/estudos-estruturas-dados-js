...
function hashCode(key) {
  ...
  console.log("Valor para 'cidade':", hashTable.get("cidade"));
  console.log("Valor para 'email':", hashTable.get("email")); // undefined
  
  // Atualizando um valor
  console.log("\nAtualizando o valor de 'idade':");
  hashTable.set("idade", 26);
  console.log("Tabela Hash após atualização:");
  console.log(hashTable.toString());
  
  // Removendo valores
  console.log("\nRemovendo valores:");
  console.log("Removendo 'profissão':", hashTable.remove("profissão"));
  console.log("Removendo 'email':", hashTable.remove("email")); // false
