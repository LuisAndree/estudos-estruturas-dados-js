...
class Edge {
    constructor(src, dest, weight) {
      this.src = src; // Vértice de origem
      this.dest = dest; // Vértice de destino
  ...
  class Graph {
    constructor(vertices) {
      ...
      this.edges = []; // Lista de arestas do grafo
    }
    ...
    // Encontra o conjunto do vértice (comprimindo caminho)
    find(parent, vertex) {
